    ...
    <v-card max-width="600px" flat class="mx-auto my-10" rounded="xl">
       ...
       <v-card-actions>
           <v-layout column justify-center align-center>
               <v-btn aria-label="band" class="primary mb-2" depressed large href="/signup/band">
                   <span>We are a band</span>
                   <v-icon right>arrow_forward_ios</v-icon>
               </v-btn>
               <v-btn aria-label="venue" class="primary mb-8" depressed large href="/signup/venue">
       ...
       <v-divider></v-divider>
       <v-card-text>
           <p class="text-center">Allready have an account? <router-link to="/login">Login</router-link></p>
       </v-card-text>
    </v-card>
</template>

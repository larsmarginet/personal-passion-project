                ...
                <v-stepper-items > 
                    <v-stepper-content step="1">
                        ...
                        <v-container>
                            ...
                            <v-btn name="continue" color="primary" class="mt-2 ml-8" @click="handleNextGeneral" depressed>Continue</v-btn>
                        </v-form>
                    </v-stepper-content>
                    <v-stepper-content step="2">
                        <v-form ref="socialForm" class="pb-5">
                            ...
                            <v-btn name="previous" color="primary" class="mr-2 ml-8" text @click="stepper = 1" depressed>Previous</v-btn>
                            <v-btn name="continue" color="primary" @click="handleSignup" depressed :loading="loading">Continue</v-btn>
                        </v-form>
                    </v-stepper-content>
                </v-stepper-items>
            </v-stepper>

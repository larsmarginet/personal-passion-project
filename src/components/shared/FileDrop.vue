<template>
    <div>
        <v-sheet tabindex="0" title="Click to upload your logo" color="grey lighten-4" width="100%" height="200" class="pa-2 d-flex flex-column justify-center rounded-lg" @click="handleClickPicker" @keypress.enter="handleClickPicker" @dragover.prevent="dragover" @dragleave="dragleave" @drop.prevent="drop" v-if="!file">
